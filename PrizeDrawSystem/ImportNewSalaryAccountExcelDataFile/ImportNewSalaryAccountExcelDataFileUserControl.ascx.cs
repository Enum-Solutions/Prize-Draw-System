...
{
    public partial class ImportNewSalaryAccountExcelDataFileUserControl : UserControl
    {
        ...
        public void ImportDataFromExcel(MemoryStream ms)
        {
            ...
            SPList oList = SPContext.Current.Web.Lists.TryGetList("New Salary Account Data");
