...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportNewSalaryAccountExcelDataFileUserControl.ascx.cs" Inherits="PrizeDrawSystem.ImportNewSalaryAccountExcelDataFile.ImportNewSalaryAccountExcelDataFileUserControl" %>
            ...
            if ($.inArray(extension, exts) > -1) {
                ...
                for (var i = 0; i < files.length; i++) {
                    ...
                    reader.onloadend = function () {
                        ...
                        filesLength--;
                        var methodUrl = [location.protocol, '//', location.host].join('') + '/_layouts/15/PrizeDrawSystem/WebAPI.aspx/UploadExcelNewSalaryAccount';
                        if (filesLength === 0) {
