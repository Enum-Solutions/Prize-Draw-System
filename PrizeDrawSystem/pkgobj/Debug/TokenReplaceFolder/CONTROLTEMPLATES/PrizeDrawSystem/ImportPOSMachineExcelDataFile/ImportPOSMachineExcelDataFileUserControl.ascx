...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportPOSMachineExcelDataFileUserControl.ascx.cs" Inherits="PrizeDrawSystem.ImportPOSMachineExcelDataFile.ImportPOSMachineExcelDataFileUserControl" %>
            ...
            if ($.inArray(extension, exts) > -1) {
                ...
                for (var i = 0; i < files.length; i++) {
                    ...
                    reader.onloadend = function () {
                        ...
                        filesLength--;
                        var methodUrl = [location.protocol, '//', location.host].join('') + '/_layouts/15/PrizeDrawSystem/WebAPI.aspx/UploadExcelPOSMachine';
                        if (filesLength === 0) {
